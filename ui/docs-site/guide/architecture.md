...
<svg viewBox="0 0 760 640" role="img" aria-label="Netra system architecture diagram" xmlns="http://www.w3.org/2000/svg">
  ...
  <text class="at" x="26" y="48">Admin dashboard</text>
  <text class="ad" x="26" y="72">web app, sign-in per role</text>

  <rect class="abox" rx="12" x="264" y="16" width="232" height="84"/>
  <text class="at" x="280" y="48">Kiosk / camera</text>
  <text class="ad" x="280" y="72">attendance at the entrance</text>

  <rect class="abox" rx="12" x="518" y="16" width="232" height="84"/>
  <text class="at" x="534" y="48">Your app (embed)</text>
  <text class="ad" x="534" y="72">self-enrollment via iframe</text>

  <!-- arrows to gateway -->
  <path class="aln" marker-end="url(#arr)" d="M 126 100 C 126 130, 260 130, 300 148"/>
  <path class="aln" marker-end="url(#arr)" d="M 380 100 L 380 144"/>
  <path class="aln" marker-end="url(#arr)" d="M 634 100 C 634 130, 500 130, 460 148"/>

  <!-- row 2: gateway -->
  <rect class="abox" rx="12" x="190" y="150" width="380" height="82"/>
  <text class="at" x="210" y="182">Access gateway</text>
  <text class="ad" x="210" y="206">serves app &amp; docs · security headers · embed origin check</text>

  <path class="aln" marker-end="url(#arr)" d="M 380 232 L 380 274"/>
  <text class="albl" x="396" y="258">secure requests · realtime</text>

  <!-- row 3: backend -->
  <rect class="abox-brand" rx="12" x="30" y="278" width="700" height="196"/>
  <text class="at" x="50" y="310">Application backend</text>

  <rect class="achip" rx="10" x="50" y="326" width="320" height="60"/>
  <text class="ad ad-strong" x="66" y="350">Core API</text>
  <text class="ad" x="66" y="372">users · devices · schedules · reports</text>

  <rect class="achip" rx="10" x="390" y="326" width="320" height="60"/>
  <text class="ad ad-strong" x="406" y="350">Realtime events</text>
  <text class="ad" x="406" y="372">pushes attendance to the dashboard</text>

  <rect class="achip" rx="10" x="50" y="398" width="320" height="60"/>
  <text class="ad ad-strong" x="66" y="422">Face matching</text>
  <text class="ad" x="66" y="444">face → signature, matched per tenant</text>

  <rect class="achip" rx="10" x="390" y="398" width="320" height="60"/>
  <text class="ad ad-strong" x="406" y="422">Liveness check</text>
  <text class="ad" x="406" y="444">rejects photos &amp; screen replays</text>

  <!-- arrows to row 4 -->
  <path class="aln" marker-end="url(#arr)" d="M 210 474 L 210 516"/>
  <path class="aln" marker-end="url(#arr)" d="M 550 474 L 550 516"/>

  <!-- row 4: data & external -->
  <rect class="abox" rx="12" x="60" y="520" width="300" height="96"/>
  <text class="at" x="76" y="552">Data store</text>
  <text class="ad" x="76" y="576">isolated per organization:</text>
  <text class="ad" x="76" y="596">people · schedules · attendance</text>

  <rect class="abox" rx="12" x="400" y="520" width="300" height="96"/>
  <text class="at" x="416" y="552">Your systems</text>
  <text class="ad" x="416" y="576">webhooks notify your backend</text>
  <text class="ad" x="416" y="596">whenever attendance is recorded</text>

  <!-- realtime back to dashboard -->
  <path class="aln-dash" marker-end="url(#arr)" d="M 730 356 C 752 340, 752 60, 750 58"/>
  <text class="albl" x="562" y="130">live updates</text>
</svg>
</div>
